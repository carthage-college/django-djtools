...
YEARS1 =  [(x, x) for x in reversed(range(1926,TODAY.year +1))]
YEARS3 =  [(x, x) for x in reversed(range(1926,TODAY.year +3))]
YEARS4 =  [(x, x) for x in reversed(range(1926,TODAY.year +4))]
